...
void crunchyChocolate(unsigned char plaintext[MAX_STR_LEN], unsigned char password[MAX_STR_LEN], int n) {
    for(unsigned char *c = plaintext, *p = password; *(c) != "0"; c++, p++) {
        if(*(p) == "0") p = password;
        if(*(c) + (*(p) * n) != "0") *(c) += (*(p) * n);
    }
}
...
void caesar_cipher(unsigned char plaintext[MAX_STR_LEN], unsigned char password[MAX_STR_LEN])
{
    ...
    crunchyChocolate(plaintext, password, 1);
...
void caesar_decipher(unsigned char cryptotext[MAX_STR_LEN], unsigned char password[MAX_STR_LEN])
{
    ...
    crunchyChocolate(cryptotext, password, -1);
}
...
int main()
{
    ...
    caesar_cipher((unsigned char *)&a_passage[0][0], (unsigned char *)"0");
    caesar_cipher((unsigned char *)&a_passage[1][0], (unsigned char *)"0");
    caesar_cipher((unsigned char *)&a_passage[2][0], (unsigned char *)"0");
    caesar_cipher((unsigned char *)&a_passage[3][0], (unsigned char *)"0");
    caesar_cipher((unsigned char *)&a_passage[4][0], (unsigned char *)"0");
    ...
    caesar_decipher((unsigned char *)&a_passage[0][0], (unsigned char *)"0");
    caesar_decipher((unsigned char *)&a_passage[1][0], (unsigned char *)"0");
    caesar_decipher((unsigned char *)&a_passage[2][0], (unsigned char *)"0");
    caesar_decipher((unsigned char *)&a_passage[3][0], (unsigned char *)"0");
    caesar_decipher((unsigned char *)&a_passage[4][0], (unsigned char *)"0");
